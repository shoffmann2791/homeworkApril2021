...
const grociers = {
collections: {
  food:["veggies", "fruit", "candy", "chips", "yogurt"],
  toiletries: ["toothpaste", "deoderant"],
  cards: ["greetings", "giftcards"],
  lifeGoals: true
},
people: = {
  workers: ["cashier", "stockers"],
  shoppers: [2, 76, 36]
}
...
console.log(grociers.collections.cards);
...
console.log('${obj.favorites.movie} and my favorite color is ${object.favorites["color"]')
